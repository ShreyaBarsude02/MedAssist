        ...
        <div className="form bg-purple-50 w-[80vw] mt-20 rounded-xl flex justify-center flex-col p-9">
          <div className="flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-x-36 md:gap-x-12 xl:gap-x-36 gap-9 my-9">
              {Object.entries(symptoms).map(([category, symptomsList]) => (
                <div key={category}>
                  <div
          ...
          <div className="mt-8">
            <div className="my-4">
              ...
              {!showPredictions && <p className="mt-2 text-gray-700">
            ...
            <span className="self-center text-2xl font-bold whitespace-nowrap dark:text-white text-slate-400">
              ...
              <div>
                <span className="text-violet-900 font-black text-2xl"> Disease Predicted</span> : <span className="text-gray-900 font-black italic text-2xl">{disease}</span>
              </div>
                ...
                <div className="pb-4">
                  {
                    !doctor && <span className="italic text-sm">Currently we dont have an specialist doctor for the above disease</span>
                  }
                  {doctor && 
                    <div className="">
                  ...
                  <div className="grid grid-cols-1">
                    {doctor && doctor.map((doc)=>{
                       <div className="w-[20vw] bg-purple-100 flex flex-col px-5 py-2 space-y-2">
                        <div className="flex justify-center">
                          <span className="font-medium text-lg text-purple-950">doc.name</span>
                        </div>
                          <div>
                            <span className="font-medium">Email</span>: <span>doc.email</span>
                          </div>
                          <div>
                            <span className="font-medium">Phone</span>: <span>doc.phone</span>
                          </div>
                          <div>
                            <span className="font-medium">Address</span>: <span>doc.address</span>
                          </div>
                          <div>
                            <span className="font-medium">Education</span>: <span>doc.education</span>
                          </div>
                          <div>
                            <span className="font-medium">Experience</span>: <span>doc.experience</span>
                          </div>
                          <div>
                            <span className="font-medium">Specialization</span>: <span>doc.specialzation</span>
                            </div>
                            <div>
                            <span className="font-medium">Description</span>: <span>doc.description</span>
                          </div>
                      </div>
                      })}
                  </div>
